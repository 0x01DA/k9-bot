...
if [ $# -gt 2 ]; then
    echo "Too many arguments. Expected at most 2, but found $#. Try \"mn\", \"mn 2\"."
    exit 3
fi
...
mnjson=$(curl --silent --compressed "https://data.messari.io/api/v1/news?fields=title,content,url,published_at&as-markdown&page=1")
